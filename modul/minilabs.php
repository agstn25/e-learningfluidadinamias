...
<?php	
	$no = 1;
	$sql = mysqli_query($koneksi,"SELECT * from minilabs order by id_minilabs desc limit 12");
...
?>
		 <div class="col-sm-4 wowload fadeInUp">
             ...
             <p align="center"><a href="?page=minilabs_detail&id=<?php echo $data['id_minilabs']; ?>"> <?php echo $data['judul']; ?></p>
			</a>
		</div>
<?php

...
<?php
$sql = mysqli_query($koneksi,"SELECT * FROM video where id='$_GET[id]'") or die (mysqli_error());
$data = mysqli_fetch_array($sql);
?>

<h2 class="sub-header">Edit video</h2>
<form name="edit" method="post" action="?page=video_editproses"
enctype="multipart/form-data" class="form-horizontal">
<input type="hidden" name="id"
value="<?php echo $data['id']; ?>">

<div class="form-group">
<label class="label-control col-md-2">Judul video</label>
<div class="col-md-4">
